export function valida(input) {
    ...
    const mensagensDeErro = {
        ...
        cep: {
            ...
            customError: 'Não foi possivel busca o CEP.'
        },
        logradouro: {
            valueMissing: 'O campo de Logradouro mão pode estar vazio.',
        },
        cidade: {
            valueMissing: 'O campo de Cidade mão pode estar vazio.',
        },
        estado: { 
...
function recuperarCep(input) {
    ...
    if(!input.validity.patternMismatch && !input.validity.valueMissing) {
        fetch(url,options).then (
            ...
            data => {
               if(data.erro) {
                input.setCustomValidity('Não foi possivel busca o CEP.')
                return 
               }
...
// 123 456 789 09 -> DIGITO VERIFICADOR EX = 09 

//Primerio digito verificador
// let soma =(10 * 1) + (9 * 2) +(8 * 3)... (2 * 9)

//Segundo digito verificador
// let soma =(11 * 1) + (10 * 2) +(9 * 3)... (2 * 0)

// let dititoVerificador = 11 - (soma % 11)